...
\begin{enumerate}[leftmargin=1.1cm]
  ...
  \item \textbf{[Completado]} Preservar \pathcode{first_activity} y \pathcode{last_activity}. Si una fecha falta, mantenerla nula o registrar \pathcode{fecha_imputada=true}; nunca reemplazar cronología real por aleatoriedad silenciosa.
...
\textit{Nota: Las correcciones 1, 2 y 3 fueron solventadas. Las correcciones restantes (4 al 8) quedan propuestas como trabajo futuro.}

...
El modelo Gold conserva la orientaci\'on dimensional planteada en el Entregable 2, organizada alrededor de una tabla de hechos y dimensiones de contexto anal\'itico. Las dimensiones finalmente materializadas responden a los atributos efectivamente consolidados en \StagingTabla{}, por lo que el dise\~no f\'isico prioriza trazabilidad, carga verificable y consistencia con los datos reales del pipeline. La dimensi\'on fuente identifica el canal de captura de la evidencia, mientras que la dimensi\'on plataforma representa el entorno de ejecuci\'on o integraci\'on del agente, por ejemplo VS Code, JetBrains, Terminal/CLI, API/SDK o cloud. Cuando no existe evidencia verificable se utiliza el miembro \texttt{No determinada}, sin copiar el nombre de la fuente.
